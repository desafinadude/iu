...
export const VOCAB_LIST = [
  ...
  // ── Time words ─────────────────────────────────────────────────────────
  // related = extra sentences showing the word in context (verb tenses, adj use, etc.)
  // sign '+' = affirmative, sign '-' = negative. Each entry is tappable to hear it.
  ...
  { word: '朝ご飯', kana: 'あさごはん', meaning: 'breakfast',             type: 'noun',   example: { jp: '朝ご飯を食べます。',       kana: 'あさごはんをたべます。',     en: 'I eat breakfast.' },
    related: [
      { sign: '+', jp: '朝ご飯を食べます。',         kana: 'あさごはんをたべます。',         en: 'I eat breakfast.' },
      { sign: '-', jp: '朝ご飯を食べません。',        kana: 'あさごはんをたべません。',        en: "I don't eat breakfast." },
      { sign: '+', jp: '朝ご飯を食べました。',        kana: 'あさごはんをたべました。',        en: 'I ate breakfast.' },
      { sign: '-', jp: '朝ご飯を食べませんでした。',  kana: 'あさごはんをたべませんでした。',  en: "I didn't eat breakfast." },
    ] },
  { word: '明日',   kana: 'あした',   meaning: 'tomorrow',               type: 'noun',   example: { jp: '明日は雨です。',           kana: 'あしたはあめです。',         en: 'Tomorrow it will rain.' },
    related: [
      { sign: '+', jp: '明日、学校へ行きます。',       kana: 'あした、がっこうへいきます。',     en: 'I go to school tomorrow.' },
      { sign: '-', jp: '明日、学校へ行きません。',      kana: 'あした、がっこうへいきません。',   en: "I won't go to school tomorrow." },
      { sign: '+', jp: '明日は楽しみです。',           kana: 'あしたはたのしみです。',           en: 'I look forward to tomorrow.' },
      { sign: '-', jp: '明日は暇じゃないです。',       kana: 'あしたはひまじゃないです。',       en: "I'm not free tomorrow." },
    ] },
  { word: 'あさって', kana: 'あさって', meaning: 'day after tomorrow',     type: 'noun',   example: { jp: 'あさって会いましょう。',   kana: 'あさってあいましょう。',     en: "Let's meet the day after tomorrow." },
    related: [
      { sign: '+', jp: 'あさって、友達に会います。',   kana: 'あさって、ともだちにあいます。',   en: 'I meet a friend the day after tomorrow.' },
      { sign: '-', jp: 'あさって、学校へ行きません。', kana: 'あさって、がっこうへいきません。', en: "I won't go to school the day after tomorrow." },
    ] },
  { word: '一昨日', kana: 'おととい', meaning: 'day before yesterday',    type: 'noun',   example: { jp: '一昨日、雨でした。',       kana: 'おととい、あめでした。',     en: 'It rained the day before yesterday.' },
    related: [
      { sign: '+', jp: '一昨日、映画を見ました。',     kana: 'おととい、えいがをみました。',     en: 'I watched a film the day before yesterday.' },
      { sign: '-', jp: '一昨日、来ませんでした。',     kana: 'おととい、きませんでした。',       en: "They didn't come the day before yesterday." },
    ] },
  { word: '昨日',   kana: 'きのう',   meaning: 'yesterday',              type: 'noun',   example: { jp: '昨日、勉強しました。',     kana: 'きのう、べんきょうしました。', en: 'I studied yesterday.' },
    related: [
      { sign: '+', jp: '昨日、図書館へ行きました。',   kana: 'きのう、としょかんへいきました。',   en: 'I went to the library yesterday.' },
      { sign: '-', jp: '昨日、学校へ行きませんでした。', kana: 'きのう、がっこうへいきませんでした。', en: "I didn't go to school yesterday." },
      { sign: '+', jp: '昨日は楽しかったです。',       kana: 'きのうはたのしかったです。',         en: 'Yesterday was fun.' },
      { sign: '-', jp: '昨日は忙しくなかったです。',   kana: 'きのうはいそがしくなかったです。',   en: 'Yesterday was not busy.' },
    ] },
  ...
  { word: '今日',   kana: 'きょう',   meaning: 'today',                  type: 'noun',   example: { jp: '今日は暑いです。',         kana: 'きょうはあついです。',       en: 'Today is hot.' },
    related: [
      { sign: '+', jp: '今日、映画を見ます。',         kana: 'きょう、えいがをみます。',         en: 'I watch a film today.' },
      { sign: '-', jp: '今日、外に出ません。',         kana: 'きょう、そとにでません。',         en: "I don't go outside today." },
      { sign: '+', jp: '今日は楽しいです。',           kana: 'きょうはたのしいです。',           en: 'Today is fun.' },
      { sign: '-', jp: '今日は寒くないです。',         kana: 'きょうはさむくないです。',         en: "Today is not cold." },
    ] },
  ...
  { word: '昼ご飯', kana: 'ひるごはん', meaning: 'lunch',                 type: 'noun',   example: { jp: '昼ご飯を食べます。',       kana: 'ひるごはんをたべます。',     en: 'I eat lunch.' },
    related: [
      { sign: '+', jp: '昼ご飯を食べます。',           kana: 'ひるごはんをたべます。',           en: 'I eat lunch.' },
      { sign: '-', jp: '昼ご飯を食べません。',          kana: 'ひるごはんをたべません。',          en: "I don't eat lunch." },
      { sign: '+', jp: '昼ご飯を食べました。',          kana: 'ひるごはんをたべました。',          en: 'I ate lunch.' },
      { sign: '-', jp: '昼ご飯を食べませんでした。',    kana: 'ひるごはんをたべませんでした。',    en: "I didn't eat lunch." },
    ] },
  ...
  { word: '晩ご飯', kana: 'ばんごはん', meaning: 'dinner',                type: 'noun',   example: { jp: '晩ご飯を作ります。',       kana: 'ばんごはんをつくります。',   en: 'I make dinner.' },
    related: [
      { sign: '+', jp: '晩ご飯を食べます。',           kana: 'ばんごはんをたべます。',           en: 'I eat dinner.' },
      { sign: '-', jp: '晩ご飯を食べません。',          kana: 'ばんごはんをたべません。',          en: "I don't eat dinner." },
      { sign: '+', jp: '晩ご飯を作りました。',          kana: 'ばんごはんをつくりました。',        en: 'I made dinner.' },
      { sign: '-', jp: '晩ご飯を作りませんでした。',    kana: 'ばんごはんをつくりませんでした。',  en: "I didn't make dinner." },
    ] },
  ...
  { word: '午前',   kana: 'ごぜん',   meaning: 'morning / AM',           type: 'noun',   example: { jp: '午前に授業があります。',   kana: 'ごぜんにじゅぎょうがあります。', en: 'There is a class in the morning.' },
    related: [
      { sign: '+', jp: '午前に勉強します。',           kana: 'ごぜんにべんきょうします。',       en: 'I study in the morning.' },
      { sign: '-', jp: '午前は授業がありません。',      kana: 'ごぜんはじゅぎょうがありません。',  en: "There's no class in the morning." },
    ] },
  { word: '午後',   kana: 'ごご',     meaning: 'afternoon / PM',         type: 'noun',   example: { jp: '午後、公園に行きます。',   kana: 'ごご、こうえんにいきます。', en: 'I go to the park in the afternoon.' },
    related: [
      { sign: '+', jp: '午後、公園に行きます。',       kana: 'ごご、こうえんにいきます。',       en: 'I go to the park in the afternoon.' },
      { sign: '-', jp: '午後は暇じゃないです。',       kana: 'ごごはひまじゃないです。',         en: "I'm not free in the afternoon." },
    ] },
  { word: '先週',   kana: 'せんしゅう', meaning: 'last week',              type: 'noun',   example: { jp: '先週、友達に会いました。', kana: 'せんしゅう、ともだちにあいました。', en: 'I met a friend last week.' },
    related: [
      { sign: '+', jp: '先週、友達に会いました。',     kana: 'せんしゅう、ともだちにあいました。', en: 'I met a friend last week.' },
      { sign: '-', jp: '先週、学校へ行きませんでした。', kana: 'せんしゅう、がっこうへいきませんでした。', en: "I didn't go to school last week." },
    ] },
  { word: '今週',   kana: 'こんしゅう', meaning: 'this week',              type: 'noun',   example: { jp: '今週は忙しいです。',       kana: 'こんしゅうはいそがしいです。', en: 'This week is busy.' },
    related: [
      { sign: '+', jp: '今週は忙しいです。',           kana: 'こんしゅうはいそがしいです。',     en: 'This week is busy.' },
      { sign: '-', jp: '今週は暇じゃないです。',       kana: 'こんしゅうはひまじゃないです。',   en: "I'm not free this week." },
      { sign: '+', jp: '今週、映画を見ます。',         kana: 'こんしゅう、えいがをみます。',     en: 'I watch a film this week.' },
      { sign: '-', jp: '今週、出かけません。',         kana: 'こんしゅう、でかけません。',       en: "I don't go out this week." },
    ] },
  { word: '来週',   kana: 'らいしゅう', meaning: 'next week',              type: 'noun',   example: { jp: '来週、テストがあります。', kana: 'らいしゅう、テストがあります。', en: 'There is a test next week.' },
    related: [
      { sign: '+', jp: '来週、テストがあります。',     kana: 'らいしゅう、テストがあります。',   en: 'There is a test next week.' },
      { sign: '-', jp: '来週、学校へ行きません。',     kana: 'らいしゅう、がっこうへいきません。', en: "I won't go to school next week." },
    ] },
  { word: '先月',   kana: 'せんげつ', meaning: 'last month',              type: 'noun',   example: { jp: '先月、本を買いました。',   kana: 'せんげつ、ほんをかいました。', en: 'I bought a book last month.' },
    related: [
      { sign: '+', jp: '先月、本を買いました。',       kana: 'せんげつ、ほんをかいました。',     en: 'I bought a book last month.' },
      { sign: '-', jp: '先月、旅行しませんでした。',   kana: 'せんげつ、りょこうしませんでした。', en: "I didn't travel last month." },
    ] },
  { word: '今月',   kana: 'こんげつ', meaning: 'this month',              type: 'noun',   example: { jp: '今月は寒いです。',         kana: 'こんげつはさむいです。',     en: 'This month is cold.' },
    related: [
      { sign: '+', jp: '今月は寒いです。',             kana: 'こんげつはさむいです。',           en: 'This month is cold.' },
      { sign: '-', jp: '今月は暖かくないです。',       kana: 'こんげつはあたたかくないです。',   en: "This month is not warm." },
    ] },
  { word: '来月',   kana: 'らいげつ', meaning: 'next month',              type: 'noun',   example: { jp: '来月、日本に行きます。',   kana: 'らいげつ、にほんにいきます。', en: 'I will go to Japan next month.' },
    related: [
      { sign: '+', jp: '来月、日本に行きます。',       kana: 'らいげつ、にほんにいきます。',     en: 'I will go to Japan next month.' },
      { sign: '-', jp: '来月、旅行しません。',         kana: 'らいげつ、りょこうしません。',     en: "I won't travel next month." },
    ] },
  { word: '去年',   kana: 'きょねん', meaning: 'last year',               type: 'noun',   example: { jp: '去年、日本語を始めました。', kana: 'きょねん、にほんごをはじめました。', en: 'I started Japanese last year.' },
    related: [
      { sign: '+', jp: '去年、日本語を始めました。',   kana: 'きょねん、にほんごをはじめました。', en: 'I started Japanese last year.' },
      { sign: '-', jp: '去年、日本に行きませんでした。', kana: 'きょねん、にほんにいきませんでした。', en: "I didn't go to Japan last year." },
    ] },
  { word: '今年',   kana: 'ことし',   meaning: 'this year',               type: 'noun',   example: { jp: '今年は忙しかったです。',   kana: 'ことしはいそがしかったです。', en: 'This year was busy.' },
    related: [
      { sign: '+', jp: '今年は忙しいです。',           kana: 'ことしはいそがしいです。',         en: 'This year is busy.' },
      { sign: '-', jp: '今年はあまり旅行しません。',   kana: 'ことしはあまりりょこうしません。', en: "I don't travel much this year." },
    ] },
  { word: '来年',   kana: 'らいねん', meaning: 'next year',               type: 'noun',   example: { jp: '来年、日本に行きたいです。', kana: 'らいねん、にほんにいきたいです。', en: 'I want to go to Japan next year.' },
    related: [
      { sign: '+', jp: '来年、日本に行きたいです。',   kana: 'らいねん、にほんにいきたいです。',   en: 'I want to go to Japan next year.' },
